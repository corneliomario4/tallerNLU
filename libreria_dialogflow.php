...
function obtener_intent()
{
    global $input;
    return $input["queryResult"]["intent"]["displayName"];
}
...
function obtener_variables_contexto()
{
    global $input;

    if (isset($input["queryResult"]["outputContexts"][0]["parameters"])) {
        return $input["queryResult"]["outputContexts"][0]["parameters"];
    } else {
        return "";
    }
}
